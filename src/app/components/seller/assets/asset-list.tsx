  ...
  return (
    <div className="min-h-screen bg-gradient-to-br">
      <div className="px-4 py-6 pb-24">
        ...
        {/* Create Liqwik Button - Centered and Fixed */}
        <div className="fixed bottom-20 left-1/2 transform -translate-x-1/2 z-50">
          <Link href="/assets/new">
            <button className="bg-pink-700 hover:bg-pink-800 text-white font-semibold py-4 px-8 rounded-full shadow-lg transition-all duration-300 transform hover:scale-105 flex items-center space-x-2">
              <span className="text-lg">Create Liqwik</span>
              <div className="w-6 h-6 bg-white rounded-full flex items-center justify-center">
                <span className="text-pink-700 font-bold text-sm">+</span>
              </div>
            </button>
          </Link>
        </div>
